...
all_commits = requests.get("https://api.github.com/repos/aru31/test-blog-publish/commits")
latest_sha = all_commits.json()[0]["sha"]

latest_commit = requests.get(f"https://api.github.com/repos/aru31/test-blog-publish/commits/{latest_sha}")
